    ...
    try {
      ...
      if (res.data.success && res.data.data) {
        ...
        const details: PublicListingDetail = {
          ...
          primaryPhotoThumbUrl: item.primaryPhotoThumbUrl || item.photos?.[0]?.thumbUrl || null,
        ...
        {selectedListingId ? (
          ...
          <div>
            ...
            <footer className="bg-[#0c2614] text-green-300/70 py-14">
              <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-10 items-start">
                  {/* Brand */}
                  <div className="max-w-sm">
                    ...
                    <p className="text-xs leading-relaxed">Redefining the standards of luxury travel through curated storytelling and architectural excellence.</p>
                  </div>
                  {/* Explore */}
                  <div>
